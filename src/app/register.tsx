...
const EVENT_ID = "55827cba-ae49-4a52-9f42-eefafc17279b";
  ...
  async function handleRegister() {
    try {
      if (!name.trim() || !email.trim()) {
        return Alert.alert("Iscrição", "Preencha todos os campos!");
      }
      setIsLoading(true);
      ...
      if (registerResponse.data.attendeeId) {
        ...
        Alert.alert("Iscrição", "Inscrição realizada com sucesso!", [
          {
            text: "OK",
      ...
      Alert.alert("Iscrição", "Não foi possível fazer a inscrição!");
    }
  }
