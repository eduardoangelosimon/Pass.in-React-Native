...
export function Credential({ onChangeAvatar, onExpandQRCode, data }: Props) {
  ...
  return (
    <MotiView
      ...
      from={{ opacity: 1, translateY: -height, rotateZ: "50deg", rotateY: "30deg", rotateX: "30deg" }}
    ...
    >
      ...
      <View className="bg-black/20 self-stretch items-center pb-6 border border-white/10 mx-3 rounded-2xl -mt-5">
        <ImageBackground
          ...
          className="px-6 py-8 h-40 items-center self-stretch border-b border-white/20 overflow-hidden"
        >
